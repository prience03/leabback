...
public class FocusListView extends ListView {
    ...
    private void init() {
		helper = new ListViewFocusHelper(this);
	...
	public void resetFocus() {
		((ListViewFocusHelper) helper).resetFocus();
	}

	class ListViewFocusHelper extends LayoutFocusHelper {
		public ListViewFocusHelper(ViewGroup layout) {
			super(layout);
		}
		...
		public void setSelectedView(View view) {
			...
			final View nextChildView = findViewByItsSubView(view);
			if (null != nextChildView) {
				...
				if ((r.bottom - r.top) != nextChildView.getHeight()) {
								...
								public void onScrollStateChanged(
									...
									if (OnScrollListener.SCROLL_STATE_IDLE == scrollState) {
									    if (getHeight() <= r.bottom) {
									        setSelectionFromTop(pos, getHeight() - nextChildView.getHeight() - getListPaddingTop() - getListPaddingBottom());
									    } else {
									        setSelection(pos);
									    }
									}
					...
					setSelectionFromTop(pos, nextChildView.getTop() - paddingOffset - getPaddingTop());
				}
