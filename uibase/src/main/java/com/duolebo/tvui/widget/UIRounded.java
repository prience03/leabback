...
public class UIRounded {
    ...
    public UIRounded(RoundedView view, AttributeSet attrs){
        this.view = view;
        paint = new Paint();
    ...
    private void init(AttributeSet attrs) {
        ...
        if(attrs != null) {
            TypedArray a = view.getContext().obtainStyledAttributes(attrs, R.styleable.UIRounded);
            try {
                roundWidth= a.getDimensionPixelSize(R.styleable.UIRounded_roundWidth, (int) (defaultRoundWidth*density));
                roundHeight= a.getDimensionPixelSize(R.styleable.UIRounded_roundHeight, (int) (defaultRoundHeight*density));
            } catch (Exception ignore) {
                try {
                    roundWidth = a.getFraction(R.styleable.UIRounded_roundWidth, 1, 1, roundWidth);
                    roundHeight = a.getFraction(R.styleable.UIRounded_roundHeight, 1, 1, roundHeight);
                } catch (Exception ignored) {
                }
            }

            halfRound = a.getBoolean(R.styleable.UIRounded_halfRound, false);
            adjustRoundSize = a.getBoolean(R.styleable.UIRounded_adjustRoundSize, true);

            int borderWidth= a.getDimensionPixelSize(R.styleable.UIRounded_borderWidth, 0);
            int borderColor= a.getColor(R.styleable.UIRounded_borderColor, Color.BLACK);
            if(borderWidth>0){
